# Main
## Week 5
[SNAP: Network datasets: Wikipedia vote network](https://snap.stanford.edu/data/wiki-Vote.html)
```
- See if there are groups of users that tend to vote together or support the same candidate
- See if users vote for each other
- Is the network scale-free or random
```
### Dataset information
